	...
	<div title="编辑用户信息" style="width: 660px; height: 400px;"
		...
		<form id="funcform" style="padding: 20px;">
			<table style="width: 600px;">
				...
				<tr>
					<td>部&nbsp;&nbsp;&nbsp;门<span style="color: red;">*</span></td>
					<td><input id="part" class="easyui-combobox"
						name="part" style="width: 144px;" />
					<td>部门ID<span style="color: red;">*</span></td>
					<td><input id="partid" class="easyui-combobox"
						name="partid" style="width: 90px;" disabled="disabled"/>
				</tr>
				<tr>
					<td>分配角色</td>
				...
				<tr>
					...
					<td colspan="3"><textarea cols="60" rows="4"
							class="x-form-text" name="remark">${usr.remark}</textarea></td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		...
		function saveUsr() {
			if (checkNull("#usrName")) {
				save('#funcform', 'usr/save.jspx', 'usr/index.jspx');
			}
		}
	</script>
</div>