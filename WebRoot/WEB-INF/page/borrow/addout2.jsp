...
<div class="easyui-layout" data-options="fit:true">
			...
			<table style="width: 900px;">
				...
				<tr>
					...
					<td><input type="text" class="x-form-text" id="iopcplace"
						name="iopcplace" style="width: 177px;" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>状态<span style="color: red;">*</span>
					</td>
					<td><select id="iopcstatus" class="x-form-text"
						name="iopcstatus" style="width: 179px;" >
				...
				<tr>
					...
					<td>借用日期<span style="color: red;">*</span></td>
	...
	<script type="text/javascript">
									...
									.combobox(
											{
												...
												onLoadSuccess : function() {
													...
													if (data.length > 0) {
														...
														document
																.getElementById("iopcplace").value = data[1].pcplace;
														$("#iopcstatus")
																.combobox(
																		"setValue",
																		data[1].pcstatus);
		...
		function saveAddin() {
			if (checkNull("#iopcno") &&checkNull("#ioperson") && checkStatus("#iopcstatus")) {
