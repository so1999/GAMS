...
<div class="easyui-layout" data-options="fit:true">
	<div title="编辑UNIT信息" style="width: 780px; height: 300px;"
		...
		<form id="funcform" style="padding: 20px;">
			...
			<table style="width: 900px;">
				<tr>
					...
					<td><input type="text" class="x-form-text"  disabled="disabled"
				...
				<tr>
					...
					<td><select id="utstatus" class="x-form-text" name="utstatus"
						style="width: 179px;" disabled="disabled">
							...
							<option value="内部借用">内部借出</option>
							<option value="外部借用">外部借出</option>
	...
	<script type="text/javascript">
		...
		$("#utname").combobox({
			...
			onLoadSuccess : function() {
				$("#utname").combobox("setValue", '${ut.utname}');
			}
		});
		...
		$("#utstatus").combobox({
			panelHeight : 'auto',
			onLoadSuccess : function() {
				$("#utstatus").combobox("setValue", '${ut.utstatus}');
			}
		});
		function saveUnit() {
			save('#funcform', 'unit/update.jspx', 'unit/list.jspx');
		}
	</script>
</div>
